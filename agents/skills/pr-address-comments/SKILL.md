...
description: "Use when a PR has unresolved review comments to act on — from human reviewers or LLM review bots. Reviews and addresses actionable feedback on the current branch's PR. Triggers: 'address the PR comments', 'respond to the review', 'the bot left comments on my PR'."
---
